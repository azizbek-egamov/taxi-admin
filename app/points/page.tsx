  ...
  const fetchData = async () => {
    try {
      ...
      const [transactionsResponse, driversResponse] = await Promise.all([
        apiClient.getPointTransactions(1, filters as any),
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                      ...
                      <SelectContent>
                        {drivers.map((driver) => (
                          <SelectItem key={driver.id} value={driver.id.toString()}>
                            {driver.user.full_name || "Noma'lum"} ({driver.points} ball)
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                  ...
                  <div>
                    ...
                    <Select value={transactionType} onValueChange={(value: "add" | "subtract") => setTransactionType(value)}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="add">Ball qo'shish</SelectItem>
                        <SelectItem value="subtract">Ball ayirish</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Haydovchi yoki sabab bo'yicha qidirish..."
                    value={searchTerm}
              ...
              <Select value={typeFilter} onValueChange={setTypeFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="subtract">Ayirilgan</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </CardContent>
        ...
        <div className="space-y-4">
          {filteredTransactions.map((transaction) => (
            <Card key={transaction.id} className="bg-white/80 backdrop-blur-sm border shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">{transaction.driver.user.full_name || "Noma'lum haydovchi"}</h3>
                  ...
                  <div className="text-right space-y-2 flex items-center space-x-4">
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={`text-2xl font-bold ${transaction.transaction_type === "add" ? "text-green-600" : "text-red-600"}`}>
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button variant="destructive" size="sm" disabled={deletingTransactionId === transaction.id}>
                          {deletingTransactionId === transaction.id ? <Loader2 className="w-4 h-4 animate-spin" /> : <Trash2 className="w-4 h-4" />}
                        </Button>
                      </AlertDialogTrigger>
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Haqiqatan ham bu tranzaksiyani o'chirmoqchimisiz? Bu amalni bekor qilib bo'lmaydi va tranzaksiya tarixi yo'qoladi.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
        ...
        {filteredTransactions.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Qidiruv shartlaringizni o'zgartiring yoki yangi tranzaksiya yarating</p>
          </div>
        )}
      </main>
    </div>
